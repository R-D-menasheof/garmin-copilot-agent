...
2. **ניתוח** מלא של כל המדדים — שינה, כושר, התאוששות, הרכב גוף, בריאות כללית
3. **השוואה** לדו"ח הקודם עם מגמות ↑↓→
4. **התייעצות עם 3 agents מומחים** — זה חובה, לא אופציונלי:
   - שאל את `nutrition-coach` — מה ההמלצות שלו לתזונה ותוספים בהתבסס על הנתונים?
...
5. **דו"ח** מקיף בעברית עם טבלת יום-יום, מדדים, והמלצות משולבות (מקסימום 7, לפי עדיפות)
6. **כתיבת סיכום** ל-`data/summaries/YYYY-MM-DD.md`
7. **שאלות** למשתמש על מידע חסר או אנומליות בנתונים
